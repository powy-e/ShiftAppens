...
import get_uni_names from "../../database_test/get_uni_names";
...
export async function getServerSideProps() {
    ...
    const uni = await get_uni_names({ short });
    return {
        props: {
            canteens: data,
            uni_names: uni,
...
export default function shortCanteen(props) {
    const uni_names = props.uni_names;
    ...
    return (
        <div className="bg-gray-100">
            ...
            <section className="bg-indigo-500 py-20 px-6 text-center text-white">
                ...
                <h1 className="text-4xl font-bold mb-4">{uni_names.shortName + " - " + uni_names.name}</h1>
                <p className="text-lg mb-8">General Location</p>
