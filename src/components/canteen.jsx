...
function Canteen(props) {
    ...
    <section className="m-12 px-6">
        ...
        <li className="flex justify-center m-5 mb-10">
            ...
            <Link href={"/reviews/UCreviewCanteen"} className=" text-black bg-indigo-300 py-3 px-6 rounded-full font-bold  hover:text-white hover:bg-gray-500 transition duration-300 ease-in-out">Review</Link>
        </li>
